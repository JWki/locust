...
// from dougbinks/ImGuiUtils.h
#include <math.h>
#include <ImGui/imgui.h>
#include <IconFontCppHeaders/IconsFontAwesome.h> // from https://github.com/juliettef/IconFontCppHeaders
...
namespace ImGui
{
	inline void SetupImGuiStyle(bool bStyleDark_)
	{
		...
		//style.Colors[] = ImVec4(1.00f, 1.00f, 1.00f, 0.94f);
	...
	struct FrameTimeHistogram
	{
		...
		void Draw(const char* name_)
		{
			if (ImGui::Begin(name_, NULL)) {
				int numShown = 0;
